...
import { USAccountModal } from "./USAccountModal";
                        ...
                        <TabPanels>
                            <TabPanel>
                                <Flex py='5' justifyContent={'center'} gap='10'>
                                    <Button color='black' onClick={() => navigate("/nigeria_local_government")} fontWeight={'500'} bg='#FCF1EF' py='10' w='60'>Nigerian Local Bank</Button>
                                    ...
                                    <Button color='white' onClick={() => navigate("/us_account")} fontWeight={'500'} bg='#E9634B' py='10' w='60'>US Account</Button>
                                </Flex>
                                ...
                                <Box>
                                    ...
                                    <Flex px='20' py='10' gap='5' flexDirection={'column'}>
                                        ...
                                        <Input borderRadius={'0'} placeholder="Routing Number" bg='#FCF1EF' color='#201E1F' />
                                        <Input borderRadius={'0'} placeholder="Swift Code" bg='#FCF1EF' color='#201E1F' />
                                        <Input borderRadius={'0'} placeholder="Beneficiary Address" bg='#FCF1EF' color='#201E1F' />
                                        <Input borderRadius={'0'} placeholder="Amount of Cleaques point to withdraw" bg='#FCF1EF' color='#201E1F' />
                                        <Input borderRadius={'0'} placeholder="Amount in USD" bg='#FCF1EF' color='#201E1F' />
