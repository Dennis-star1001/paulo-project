...
const NigerianDomiciallyAccount = () => {
                        ...
                        <TabPanels>
                            <TabPanel>
                                <Flex py='5' justifyContent={'center'} gap='10'>
                                    ...
                                    <Button color='white' onClick={() => navigate("/nigeria_domicially_account")} fontWeight={'500'} bg='#E9634B' py='10' w='60'>Nigerian domicially account</Button>
                                ...
                                <Box>
                                    ...
                                    <Flex px='20' py='10' gap='5' flexDirection={'column'}>
                                        ...
                                        <Input borderRadius={'0'} placeholder="E-mail Address " bg='#FCF1EF' color='#201E1F' />
                                        <Input borderRadius={'0'} placeholder="Phone Number " bg='#FCF1EF' color='#201E1F' />
...
export default NigerianDomiciallyAccount;
