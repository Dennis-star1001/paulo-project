...
export const SharePointModal = () => {
    ...
    return (
        <>
            ...
            <Button onClick={onOpen} mt='20' mx='20' color='white' bg='#E9634B'>Send Points</Button>
            ...
            >
                ...
                <ModalContent textAlign={'center'}>
                    <ModalHeader fontSize={'sm'}>Share Points</ModalHeader>
                    <ModalCloseButton />
                    <Box>
                        <Text fontSize={'sm'}>Share 1,000 Cleaques points</Text></Box>
                    <ModalBody>
                        <Box>
                    ...
                    <Button w='full' onClick={onClose}  color='white' bg='#E9634B'>Share Points</Button>
