                                ...
                                <Flex  py='5' justifyContent={'center'} gap='10'>
                                    ...
                                    <Box >
                                        ...
                                        <Flex px='20' py='10' gap='5' flexDirection={'column'}>
                                            ...
                                            <Input borderRadius={'0'} placeholder="Share to" bg='#FCF1EF' color='#201E1F' />
                                            <Input borderRadius={'0'} placeholder="Points to send" bg='#FCF1EF' color='#201E1F' />
