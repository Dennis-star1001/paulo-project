...
function MakeDonation() {
    ...
    return (
        <>
            ...
            <Button onClick={openFirstModal} w='fit-content'>Donate Again</Button>


            <Modal
                initialFocusRef={initialRef}
                finalFocusRef={finalRef}
                isOpen={isFirstModalOpen} onClose={closeFirstModal}
            >
                <ModalOverlay />
                <ModalContent bg={'rgba(241, 245, 249, 1)'}>
                    ...
                    <Flex mx='10' mb='10' gap='3' alignItems={'center'} flexDirection={'column'}>
                        <Button onClick={closeFirstModal} w='full' bg='rgba(0, 176, 243, 1)'>Check out $1,420.00</Button>
                        <Text>Or</Text>
                        <Button onClick={openSecondModal} w='full' bg='rgba(233, 99, 75, 1)'>Pay with point</Button>
                    </Flex>
            ...
            <Modal isOpen={isSecondModalOpen} onClose={closeSecondModal}>
                ...
                <ModalContent bg={'rgba(241, 245, 249, 1)'} h='100%' py='5'>
                    <ModalBody>
                        <Box>
                            <Button onClick={openFirstModal} _hover={{ bg: 'none' }} leftIcon={<BsArrowLeft />} bg='none' color='black' fontWeight={'normal'}>Pay with Points</Button>
                            <Box py='5'>
                                <Input bg='white' placeholder="Amount of points" />
                                <Text py='1' fontSize={'xs'} color={'#00B0F3'}>Points Balance:  22,646</Text>
                    ...
                    <ModalFooter>
                        <Button w='full' onClick={closeSecondModal}>Donate Points</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
