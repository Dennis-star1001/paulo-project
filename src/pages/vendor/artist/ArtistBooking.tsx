            ...
            >
              <HStack spacing={4} flexDirection={{ base: 'column', md: 'row' }}>
                ...
                <VStack alignItems={{ base: 'center', md: 'flex-start' }} spacing={0.5}>
                  <Heading fontSize='1rem' textAlign={{ base: 'center' }} color='primary'>
                    2 MINUTES AFROBEATS HAPPY SONG
                  </Heading>
                  <Text fontSize='0.85rem' as='b'>
                    2 Minutes Song
                  </Text>
                  <Text fontSize='0.85rem'>
                    Client: <Text as='b'>Adedoyin Dolapo</Text>
                  </Text>
                  <Text as='span' fontSize='0.85rem'>
                    <CalendarIcon /> August 12, 2023
                  </Text>
                </VStack>
              </HStack>
              ...
              <VStack spacing={1}>
                ...
                <Button alignSelf='center' variant='ghost' color='primary' fontWeight='500' as='a'>
                  Message Client
                </Button>
              </VStack>
            </Flex>
