				...
				<Box bg='neutral.100' p={[4, '100px']}>
			  		<Container maxW="1000px" p="0">
			  			...
			  			<Flex justifyContent="space-between" my="20px" alignItems="center" wrap="flex-wrap">
			  				<Box>
			  					<Text as='h3'>Wallet Balance: <Text as="span" color="primary">$256.50</Text></Text>
			  				</Box>
			  				<Box>
			  					<Button>Add Sample Song</Button>
			  				</Box>
			  			</Flex>
				        ...
				        >
				        	<GridItem bg="white" px="20px" py="30px">
				        		<Flex justifyContent="space-between" alignItems="center">
				        			<Text as="p" fontWeight="600" fontSize="1.3rem">Wallet</Text>
				        	...
				        	<GridItem bg="white" px="20px" py="30px">
				        		<Flex justifyContent="space-between" alignItems="center">
				        			<Text as="p" fontWeight="600" fontSize="1.3rem">Analytics</Text>
				        	...
				        	<GridItem bg="white" px="20px" py="30px">
				        		<Flex justifyContent="space-between" alignItems="center">
				        			<Text as="p" fontWeight="600" fontSize="1.3rem">Promote</Text>
				        ...
				        <Divider my="30px"/>
				        	...
				        	<Container mx="auto" maxW="600px" bg="white" borderTop="4px solid #00B0F3" p='20px' borderRadius="5px">

				        		<Flex alignItems="center" justifyContent="space-between" my='10px'>
				        			<Heading as='h4' fontSize="1.1rem">PROJECTS</Heading>

				        			<Link color='primary' href="">View All</Link>
				        		</Flex>
				        		...
				        		>
				        			<GridItem>
				        				<VStack textAlign="center" bg="gray.200" px="10px" py="12px" borderRadius="5px 0 0  5px" spacing={0}>
				        					<Text as="p" fontWeight='600'>10</Text>
				        			...
				        			<GridItem>
				        				<VStack textAlign="center" bg="gray.200" px="10px" py="12px" borderRadius=" 0 5px  5px 0" spacing={0}>
				        					<Text fontWeight='600'>10</Text>
				        		...
				        		<Stack mt="20px">
				        			<Box p="10px">
				        				<Flex justifyContent="space-between" mb="10px" py='10px' borderBottom="1px solid" borderColor="gray.100">
				        					<Box>
				        						<HStack>
				        							<Avatar 
				        							...
				        							<VStack spacing={0} alignItems="flex-start">
				        								...
				        								<Text color="primary" fontSize="0.8rem">Song Name</Text>
