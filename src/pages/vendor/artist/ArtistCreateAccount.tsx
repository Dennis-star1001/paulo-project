...
import { FormInput, FormLeftAddonInput, FormSelect, FormTextArea, FormCheckBox } from '@/components';
			...
			<BeforeLoginHeader/>
			  ...
			  <Box p={[4, '80px']}>
			  	...
			  	<Container maxW="600px" p="0">
			  		<Heading fontSize="1.4rem" textAlign="center" my={{base:"40px", md:"10px"}}>CREATE AND ARTIST ACCOUNT</Heading>
			  		<FormikProvider value={formik}>
			  			<Form spacing="20px">
			                ...
			                />
			                <Text mb="20px" fontSize=".8rem" mt="3px">Artists can add up to three genres</Text>
			                ...
			                <HStack mb="25px">
			                 ...
			                 <FormInput
				              ...
				              <Text fontSize="0.8rem" pl="20px">You consent to receive phone calls and SMS from Cleaques to provide updates on your order and/or for marketing purposes</Text>

				              <Box display='flex' justifyContent="center">
				              	<Button my="20px" width="80%" py="15px" h="auto">Sign Up</Button>	
				              </Box>
