    ...
    return (
        <Box bg='white' p='20'>
            <Flex w={'full'} flexDirection={'column'} alignItems={'center'} justifyContent={'center'} gap='10'>
                ...
                <Button  color='black' onClick={() => navigate("/vendor/withdrawal/nigeria-local-bank")} fontWeight={'500'}  bg='#E1EEF3' py='10' w='60'>Nigerian Local Bank</Button>
                    ...
                    <Button color='white'  onClick={() => navigate("/vendor/withdrawal/us-account")} fontWeight={'500'} py='10' w='60'>US Account</Button>
                </Flex>
...
export default WithdrawalUSAccount;
