...
<UserProfile username="Ayodeji Iyanuoluwa"  type='Vendor' profileImage="url_to_profile_image.jpg" />
       <Menu>
              ...
              <MenuList border="none" bg="#FFFFFF" p="1rem">
                ...
                <MenuItem border="none" bg="#FFFFFF" minH="40px">
    ...
    <>
      <Box display='flex' alignItems='center' bg='white' h='79px' p='4'>
        ...
        <Box display='flex' alignItems='center' gap="1">
          <Image src={addCircle} alt='addCircle'    w='24px'
              h='28px'/>
